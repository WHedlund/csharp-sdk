...
/// <summary>
/// MonoBehaviour that discovers and caches MCP tools/resources/prompts for a GameObject tree.
/// Prompts are currently stubbed (discovery returns empty) until implementation is added.
/// </summary>
